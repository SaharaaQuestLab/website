  ...
  return (
    <div className="w-full">
      ...
      <div className="min-h-11 mb-[3.75rem] tablet:mb-11 mobile:mb-7 flex gap-x-5 tablet:gap-x-3 gap-y-7 whitespace-pre-wrap max-w-full flex-wrap">
        <div ref={select1} className="border flex-1 mobile:min-w-[43%] px-4 text-sm mobile:text-xs py-2.5 cursor-pointer relative z-10 rounded-xl group border-light-100 flex items-center justify-between">
        ...
        <div ref={select2} className="border flex-1 mobile:min-w-[43%] px-4 text-sm mobile:text-xs py-2.5 cursor-pointer relative z-10 rounded-xl group border-light-100 flex items-center justify-between">
